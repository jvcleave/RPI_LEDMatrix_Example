...
HT1632LEDMatrix::HT1632LEDMatrix()
{
    _width = 0;
    _height = 0;
    matrixNum = 0;
...
void HT1632LEDMatrix::setup(uint8_t data, uint8_t wr, uint8_t cs1) {
    ...
    ofLog() << "_width: " << (int)_width;
    ofLog() << " _height: " << (int)_height;

    ofLog() << " matrixNum: " << (int)matrixNum;

    
    //printf("printf matrixNum: %d", matrixNum);

}

void HT1632LEDMatrix::setup(uint8_t data, uint8_t wr, 
